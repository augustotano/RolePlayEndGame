...
{
    /*
    Una sub-clase de Items son los items mixtos, que tienen valor de ataque y defensa,
    por lo que se decidió volver a utilizar herencia para que todos los objetos
    basados en esta clase tengan acceso a esos dos atributos.
    ...
    */
    public abstract class MixItem : Items
    {
